...
export class AppComponent {
  ...
  hideHeaderFooterRoutes: string[] = ['/home', '/login', '/register', '/admin-dashboard', '/admin/category-list', '/admin/category-add', '/admin/quiz-list', '/admin/quiz-add', '/admin/users', '/admin/result'];
